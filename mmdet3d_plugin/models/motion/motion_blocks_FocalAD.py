...
class FocalADMotionPlanningRefinementModule(BaseModule):
    def __init__(
        self,
        embed_dims=256,
        fut_ts=12,
        ...
        super(FocalADMotionPlanningRefinementModule, self).__init__()
    ...
    def forward(
        ...
        if self.use_gru:
            ...
            mlp = nn.Linear(36 * 256, 6 * 256)
            plan_query = mlp(plan_query)
            # 重新整形为[1, 1, 6, 256]
            plan_query = plan_query.view(1, 1, 6, 256)
