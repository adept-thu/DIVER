...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            type='FocalADMotionPlanningHead',
            fut_ts=fut_ts,
            fut_mode=fut_mode,
            ...
            refine_layer=dict(
                type="FocalADMotionPlanningRefinementModule",
                embed_dims=embed_dims,
                fut_ts=fut_ts,
                fut_mode=fut_mode,
                ego_fut_ts=ego_fut_ts,
            ...
            motion_feature_refine=dict(
                type = "FocalADMotionFeatureRefine",
                num_heads=num_groups,
                d_model=embed_dims,
            ),
