...
load_from = None
resume_from = 'work_dirs/sparsedrive_small_b2d_stage2_targetpoint_multiplan_drivestyle/iter_117384.pth'
workflow = [("train", 1)]
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            type='DriveStyleMotionPlanningHead',
            fut_ts=fut_ts,
            fut_mode=fut_mode,
            ...
            diff_refine_noise_layer=dict(
                type="V4DiffMotionPlanningNoiseRefinementModule",
                embed_dims=embed_dims,
                fut_ts=fut_ts,
                fut_mode=fut_mode,
                ego_fut_ts=ego_fut_ts,
