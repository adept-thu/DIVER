...
TEAM_CONFIG=/data/songziying/workspace/SparseDriveb2d/adzoo/sparsedrive/configs/sparsedrive_small_b2d_stage2_targetpoint_multiplan_drivestyle.py+/data/songziying/workspace/SparseDriveb2d/ckpt/iter_117384.pth
BASE_CHECKPOINT_ENDPOINT=eval_bench2drive220_sparsedrive
PLANNER_TYPE=traj
ALGO=vad
SAVE_PATH=./eval_bench2drive220_sparsedrive_${ALGO}_${PLANNER_TYPE}
